                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromPins(
                      ...
                      child: SvgPicture.string(
                        '<svg viewBox="37.0 26.0 22.0 1.0" ><path transform="translate(37.0, 26.0)" d="M 0 0 L 22 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>',
                        allowDrawingOutsideViewBox: true,
                        fit: BoxFit.fill,
                      ),
                    ),
                    Pinned.fromPins(
                      ...
                      child: SvgPicture.string(
                        '<svg viewBox="37.0 39.0 22.0 1.0" ><path transform="translate(37.0, 39.0)" d="M 0 0 L 22 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>',
                        allowDrawingOutsideViewBox: true,
                        fit: BoxFit.fill,
                      ),
                    ),
                    Pinned.fromPins(
                      ...
                      child: SvgPicture.string(
                        '<svg viewBox="37.0 32.0 15.0 1.0" ><path transform="translate(37.0, 32.0)" d="M 0 0 L 15 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>',
                        allowDrawingOutsideViewBox: true,
                        fit: BoxFit.fill,
                      ),
                    ),
