...
//                     tabs: [
//                      // Text("Sales Register",style: TextStyle(color: Colors.white)),
//                       Text("Sales Ledger",style: TextStyle(color: Colors.white)),
//                       Text("Stock Reports",style: TextStyle(color: Colors.white))
//                     ],
//                   ),
//                 ),
//               ];
